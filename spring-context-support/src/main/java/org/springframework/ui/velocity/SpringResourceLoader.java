...
/**
 * 通过Spring ResourceLoader加载的Velocity ResourceLoader适配器.
 * 由VelocityEngineFactory用于任何无法解析为{@code java.io.File}的资源加载器路径.
 *
 * <p>请注意, 此加载程序不允许修改检测:
 * 使用Velocity的默认FileResourceLoader, 用于{@code java.io.File}资源.
 *
 * <p>在Velocity运行时期望"spring.resource.loader" 和 "spring.resource.loader.path"应用程序属性:
 * 前者类型为 {@code org.springframework.core.io.ResourceLoader}, 后者为String.
 */
