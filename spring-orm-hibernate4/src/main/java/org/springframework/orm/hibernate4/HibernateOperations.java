...
/**
 * Interface that specifies a basic set of Hibernate operations, implemented by {@link HibernateTemplate}.
 * Not often used, but a useful option to enhance testability, as it can easily be mocked or stubbed.
 *
 * <p>Defines {@code HibernateTemplate}'s data access methods that mirror various {@link org.hibernate.Session} methods.
 * Users are strongly encouraged to read the Hibernate {@code Session} javadocs for details on the semantics of those methods.
 */
public interface HibernateOperations {

	/**
	 * Execute the action specified by the given action object within a {@link org.hibernate.Session}.
	 * <p>Application exceptions thrown by the action object get propagated to the caller (can only be unchecked).
	 * Hibernate exceptions are transformed into appropriate DAO ones.
	 * Allows for returning a result object, that is a domain object or a collection of domain objects.
	 * <p>Note: Callback code is not supposed to handle transactions itself!
	 * Use an appropriate transaction manager like {@link HibernateTransactionManager}.
	 * Generally, callback code must not touch any {@code Session} lifecycle methods, like close, disconnect, or reconnect, to let the template do its work.
	 * 
	 ...
	 * <p>This method is a thin wrapper around {@link org.hibernate.Session#get(Class, java.io.Serializable)} for convenience.
	 ...
	 * <p>This method is a thin wrapper around {@link org.hibernate.Session#get(Class, java.io.Serializable, LockMode)} for convenience.
	 * For an explanation of the exact semantics of this method, please do refer to the Hibernate API documentation in the first instance.
	 * 
	 * @param entityClass a persistent class
	 * @param id the identifier of the persistent instance
	...
	/**
	 * Return the persistent instance of the given entity class with the given identifier, or {@code null} if not found.
	 * <p>This method is a thin wrapper around {@link org.hibernate.Session#get(String, java.io.Serializable)} for convenience.
	 * For an explanation of the exact semantics of this method, please do refer to the Hibernate API documentation in the first instance.
	 * 
	 ...
	 * <p>This method is a thin wrapper around {@link org.hibernate.Session#get(String, java.io.Serializable, LockMode)} for convenience.
	 * For an explanation of the exact semantics of this method, please do refer to the Hibernate API documentation in the first instance.
	 * 
	 * @param entityName the name of the persistent entity
	 * @param id the identifier of the persistent instance
	 ...
	 * <p>This method is a thin wrapper around {@link org.hibernate.Session#load(Class, java.io.Serializable)} for convenience.
	 * For an explanation of the exact semantics of this method, please do refer to the Hibernate API documentation in the first instance.
	 * 
	 * @param entityClass a persistent class
	 * @param id the identifier of the persistent instance
	 ...
	 * Return the persistent instance of the given entity class with the given identifier, throwing an exception if not found.
	 * Obtains the specified lock mode if the instance exists.
	 * <p>This method is a thin wrapper around {@link org.hibernate.Session#load(Class, java.io.Serializable, LockMode)} for convenience.
	 * For an explanation of the exact semantics of this method, please do refer to the Hibernate API documentation in the first instance.
	 * 
	 * @param entityClass a persistent class
	 * @param id the identifier of the persistent instance
	...
	/**
	 * Return the persistent instance of the given entity class with the given identifier, throwing an exception if not found.
	 * <p>This method is a thin wrapper around {@link org.hibernate.Session#load(String, java.io.Serializable)} for convenience.
	 * For an explanation of the exact semantics of this method, please do refer to the Hibernate API documentation in the first instance.
	 * 
	 * @param entityName the name of the persistent entity
	 * @param id the identifier of the persistent instance
	 ...
	 * Return the persistent instance of the given entity class with the given identifier, throwing an exception if not found.
	 * <p>Obtains the specified lock mode if the instance exists.
	 * <p>This method is a thin wrapper around {@link org.hibernate.Session#load(String, java.io.Serializable, LockMode)} for convenience.
	 * For an explanation of the exact semantics of this method, please do refer to the Hibernate API documentation in the first instance.
	 * 
	 * @param entityName the name of the persistent entity
	 * @param id the identifier of the persistent instance
	 ...
	 * <p>This method is a thin wrapper around {@link org.hibernate.Session#load(Object, java.io.Serializable)} for convenience.
	 * For an explanation of the exact semantics of this method, please do refer to the Hibernate API documentation in the first instance.
	 * 
	...
	/**
	 * Update the given persistent instance, associating it with the current Hibernate {@link org.hibernate.Session}.
	 * <p>Obtains the specified lock mode if the instance exists, implicitly checking whether the corresponding database entry still exists.
	 * 
	 * @param entity the persistent instance to update
	 * @param lockMode the lock mode to obtain
	 * 
	 ...
	 * <p>Similar to {@code save}, associating the given object with the current Hibernate {@link org.hibernate.Session}.
	 * 
	 ...
	 * <p>Similar to {@code saveOrUpdate}, but never associates the given object with the current Hibernate Session.
	 * In case of a new entity, the state will be copied over as well.
	 * <p>Note that {@code merge} will <i>not</i> update the identifiers in the passed-in object graph (in contrast to TopLink)!
	 * Consider registering Spring's {@code IdTransferringMergeEventListener} if you would like to have newly assigned ids transferred to the original object graph too.
	 * 
	...
	/**
	 * Copy the state of the given object onto the persistent object with the same identifier. Follows JSR-220 semantics.
	 * <p>Similar to {@code saveOrUpdate}, but never associates the given object with the current Hibernate {@link org.hibernate.Session}.
	 * In the case of a new entity, the state will be copied over as well.
	 * <p>Note that {@code merge} will <i>not</i> update the identifiers in the passed-in object graph (in contrast to TopLink)!
	 * Consider registering Spring's {@code IdTransferringMergeEventListener} if you would like to have newly assigned ids transferred to the original object graph too.
	 * 
	 * @param entityName the name of the persistent entity
	 ...
	 * <p>Only invoke this for selective eager flushing, for example when JDBC code needs to see certain changes within the same transaction.
	 ...
	 * <b>Note: Do not reuse criteria objects! They need to recreated per execution, due to the suboptimal design of Hibernate's criteria facility.</b>
	 * 
	 * @return a {@link List} containing 0 or more persistent instances
	 * @throws org.springframework.dao.DataAccessException in case of Hibernate errors
	 */
	 ...
	 * <p>Returns the results as an {@link Iterator}. Entities returned are initialized on demand. See the Hibernate API documentation for details.
	 * 
	 * @param queryString a query expressed in Hibernate's query language
	 * @param values the values of the parameters
	 * 
