 ...
 *
 * <p>需要设置{@link org.hibernate.SessionFactory}, 通过{@link #getHibernateTemplate()}方法
 * 将{@link org.springframework.orm.hibernate4.HibernateTemplate}基于它提供给子类.
 ...
 * 因此, 对于新启动的项目, 请考虑采用标准的Hibernate风格的编码数据访问对象,
