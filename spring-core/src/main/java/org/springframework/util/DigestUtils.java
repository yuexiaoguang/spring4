 ...
 *
 * <p>主要供框架内部使用;
 * 考虑使用<a href="http://commons.apache.org/codec/">Apache Commons Codec</a>来获得更全面的摘要实用程序套件.
 */
public abstract class DigestUtils {
	 ...
	 * 计算给定流的MD5摘要.
	 * 
	 * @param inputStream 要计算摘要的InputStream
	 * 
	 * @return 摘要
	 */
	...
	/**
	 * 将给定字节的MD5摘要的十六进制字符串表示附加到给定的{@link StringBuilder}.
	 * 
	 * @param bytes 用于计算摘要的字节
	...
	/**
	 * 将给定inputStream的MD5摘要的十六进制字符串表示附加到给定的{@link StringBuilder}.
	 * 
	 ...
	 * 必要, 因为{@code MessageDigest}不是线程安全的.
	 */
