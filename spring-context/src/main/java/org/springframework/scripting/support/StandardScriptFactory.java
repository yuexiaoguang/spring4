...
/**
 * 基于JSR-223脚本引擎抽象的{@link org.springframework.scripting.ScriptFactory}实现 (包含在Java 6+中).
 * 支持JavaScript, Groovy, JRuby和其他符合JSR-223标准的引擎.
 *
...
public class StandardScriptFactory implements ScriptFactory, BeanClassLoaderAware {
	...
	/**
	 * @param scriptEngineName 要使用的JSR-223 ScriptEngine的名称
	 * (明确给出而不是从脚本源推断)
	 * @param scriptSourceLocator 指向脚本源的定位器.
	 * 由实际创建脚本的后处理器解释.
	 */
